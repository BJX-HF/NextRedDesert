...
void ACombatCharacter::InitializeAbilitySystem()
{
	...
	AbilitySystemComponent->GetGameplayAttributeValueChangeDelegate(UAITestAttributeSet::GetHealthAttribute()).AddUObject(this, &ACombatCharacter::HandleHealthChanged);
