 ...
 */
UCLASS(abstract)
class ACombatEnemy : public ACharacter, public IAbilitySystemInterface, public ICombatAttacker, public ICombatDamageable
{
	GENERATED_BODY()
...
public:
	...
	/** Startup abilities granted when the ability system initializes */
...
protected:
	...
	/** Prevents startup abilities from being granted more than once */
...
protected:
	...
	/** Initializes GAS actor info, delegates, and startup abilities */
	void InitializeAbilitySystem();

	/** Grants configured startup abilities */
	void GrantStartupAbilities();

	/** Syncs cached health values and UI when GAS health changes */
